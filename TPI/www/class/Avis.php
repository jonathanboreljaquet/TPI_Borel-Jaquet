 ...
 *          $a->id_avis = "2";
 *          $a->date = "27/03/19";
 *          $a->comment = "Bonjour, mon ordinateur à fréquemment des écrans bleus, est-ce dans vos compétences ?";
 * 					$a->est_valide = "FALSE";
 * 					$a->id_reparateur = "1";
 * 
 * 
 *          Exemple d'utilisation 2
 *          $a = new Avis("2", "27/03/19", "Bonjour\, mon ordinateur à...",FALSE,1);
 */
class Avis
{
	/**
	 * @brief	Le Constructor appelé au moment de la création de l'objet ex: new Avis();
