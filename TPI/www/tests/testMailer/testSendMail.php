...
require_once $_SERVER['DOCUMENT_ROOT'].'/www/swiftmailer5/lib/swift_required.php';
...
try {
    ...
    $message->setFrom(array('infoboboTPI@gmail.ch' => 'Infobobo réparation'));
    // A qui on envoie le message
    $message->setTo(array('jonathan.brljq@eduge.ch'));
...
echo "Message envoyé à dominique.aigroz@edu.ge.ch";
